...
curl -k --data "event_type=interactive_session_ready&address=${INTERACTIVE_SESSION_ADDRESS}&owner=${AGAVE_JOB_OWNER}&job_uuid=${AGAVE_JOB_ID}" "${_INTERACTIVE_WEBHOOK_URL}" &
