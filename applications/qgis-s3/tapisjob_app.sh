...
export DISPLAY
xterm $(apptainer run docker://qgis/qgis:final-3_34_4 qgis --profiles-path $STOCKYARD/qgis --code /work/projects/wma_apps/stampede2/qgis/set_favorite_dir.py --noversioncheck)
